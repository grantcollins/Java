/*
* This Java program creates a GUI for a student database. It utilizes
...
public class GUI extends JFrame {
                    ...
                    switch (select) {
                        case "Insert": // Insert
                            if (database.containsKey(id)) {
                                ...
                                JOptionPane.showMessageDialog(null, "This student has been added to the database.");
                                clearInput();
                            }
                            break;
                        case "Delete": // Delete
                            if (!database.containsKey(id)) {
                                ...
                                database.remove(id);
                                JOptionPane.showMessageDialog(null, "This student has been removed from the database.");
                                clearInput();
                            }
                            break;
                        case "Find": // Find
                            if (!database.containsKey(id)) {
                                ...
                                JOptionPane.showMessageDialog(null, "This student is in the database.\nId: " + id + toString);
                                clearInput();
                            }
                            break;
                        case "Update": // Update
                            if (!database.containsKey(id)) {
                                ...
                                if (grade != null) { // Valid Grade
                                    ...
                                    if (creditHours != null) { // Valid Credit
                                        ...
                                        JOptionPane.showMessageDialog(null, "This student's record has updated.");
                                        clearInput();
                                    }
                                    else {
    ...
    public GUI() {
        // Frame Creation
        super("Student Database"); // Titling frame
        setSize(250, 180);
